...
from .data import flights_by_origin
from .rules import (LSP_PER_SEGMENT, fop_per_segment, safe_mct, PATTERNS)
...
def _flights_by_origin_cache(flight_date: date) -> dict[str, list[dict]]:
    """その日に運航する便を出発空港別に (CSVから)."""
    return flights_by_origin(flight_date)
